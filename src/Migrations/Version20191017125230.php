 ...
 */
final class Version20191017125230 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE adherent_correct');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adherent_correct (id INT DEFAULT 0 NOT NULL, login VARCHAR(255) NOT NULL COLLATE utf8_general_ci, password VARCHAR(255) NOT NULL COLLATE utf8_general_ci) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE plats (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE latin1_swedish_ci, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
