 ...
 */
final class Version20191108073314 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE msalsas_voting_clicks (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, reference INT NOT NULL, user_ip VARCHAR(180) DEFAULT NULL, INDEX IDX_42A654E1A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE msalsas_voting_reference_clicks (reference INT NOT NULL, clicks INT NOT NULL, PRIMARY KEY(reference)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE msalsas_voting_reference_votes (reference INT NOT NULL, positiveVotes INT NOT NULL, negativeVotes INT NOT NULL, userVotes INT NOT NULL, anonymousVotes INT NOT NULL, published INT NOT NULL, PRIMARY KEY(reference)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE msalsas_voting_negative_votes (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, reference INT NOT NULL, user_ip VARCHAR(180) DEFAULT NULL, reason VARCHAR(180) NOT NULL, INDEX IDX_A70D00ABA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE msalsas_voting_positive_votes (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, reference INT NOT NULL, user_ip VARCHAR(180) DEFAULT NULL, INDEX IDX_85A638A7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE comment CHANGE text_comment text_comment LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE text_comment text_comment VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
